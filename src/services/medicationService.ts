...
// Fetch medications directly from Supabase database
export const fetchMedications = async (): Promise<Medication[]> => {
  try {
    ...
    console.error('Failed to fetch medications from Supabase:', err)
    return []
  }
}

// Fetch categories directly from Supabase database
...
// Fetch pharmacies directly from Supabase database
export const fetchPharmacies = async (): Promise<PharmacyData[]> => {
  try {
    ...
    console.error('Failed to fetch pharmacies from Supabase:', err)
    return []
  }
}

// Fallback image helper if a medication record has empty image_url in Supabase
