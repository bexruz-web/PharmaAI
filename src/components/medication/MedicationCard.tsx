...
export const MedicationCard: React.FC<MedicationCardProps> = ({
  ...
  return (
    <Card hoverable className="p-2.5 flex flex-col justify-between h-full bg-white dark:bg-[#1E1E20] border border-slate-200/80 dark:border-zinc-800 rounded-2xl shadow-xs overflow-hidden">
      {/* 1. TOP IMAGE CONTAINER & OVERLAYS (Prominent image size) */}
      <div className="relative w-full aspect-square rounded-xl bg-slate-100 dark:bg-[#252528] overflow-hidden border border-slate-200/50 dark:border-zinc-800/80 mb-2">
